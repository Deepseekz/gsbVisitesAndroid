...
class ProduitsVisitesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'FK_visites_produits_visites' => ['type' => 'foreign', 'columns' => ['visite_id'], 'references' => ['visites', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'FK_visites_produits_produits' => ['type' => 'foreign', 'columns' => ['produit_id'], 'references' => ['produits', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
