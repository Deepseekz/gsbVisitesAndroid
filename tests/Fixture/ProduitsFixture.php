...
class ProduitsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'prixIndicatif' => ['type' => 'decimal', 'length' => 18, 'precision' => 2, 'null' => true, 'default' => null, 'comment' => null, 'unsigned' => null],
        'numeroDepot' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'French_CI_AS', 'precision' => null, 'comment' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'prixIndicatif' => 1.5,
                'numeroDepot' => 'Lorem ipsum dolor sit amet',
                'famille_id' => 1
            ],
        ];
        parent::init();
